    ...
    public void publishToPubSub(JsonObject numberJsonObject) {
        ...
        try {
            ...
            if (publisher == null) {
                ...
                //Credentials creds = ServiceAccountCredentials.fromStream(new FileInputStream(System.getenv("GOOGLE_APPLICATION_CREDENTIALS")));
                ...
                ApiFutures.addCallback(
                        ...
                        new ApiFutureCallback<String>() {
                            ...
                            public void onFailure(Throwable throwable) {
                                ...
                                System.out.println("Error publishing message : " + pubsubMessage);
                            }
